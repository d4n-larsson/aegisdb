...
| `AEGIS_GROUNDING_MAX_MINT` | `8` | new entity records per extraction. Past the cap a mention is reported unresolved and its triple dropped — one lost fact, rather than a wrong resolution that would cost every conclusion drawn from it |
